...
class Aquifer(Base):
    ...
    id = Column(
        ...
        AQUIFER_ID_SEQ,
        primary_key=True,
        server_default=AQUIFER_ID_SEQ.next_value(),
    )
    ...
    region = relationship(
        ...
        backref=backref("regions", cascade="delete,all"),
    )
...
class Well(Base):
    ...
    __tablename__ = "well"
    id = Column(
        Integer, WELL_ID_SEQ, primary_key=True, server_default=WELL_ID_SEQ.next_value()
    )
    ...
    aquifer = relationship(
        ...
        backref=backref("aquifers", cascade="delete,all"),
    )
...
class Measurement(Base):
    ...
    well = relationship(
        ...
        backref=backref("wells", cascade="delete,all"),
    )
