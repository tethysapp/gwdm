...
class Gwdm(TethysAppBase):
    ...
    def url_maps(self):
        ...
        url_maps = (
            UrlMap(name="home", url="gwdm", controller="gwdm.controllers.home"),
            UrlMap(
                name="config", url="gwdm/config", controller="gwdm.controllers.config"
            ),
            UrlMap(
                name="metrics",
                url="gwdm/metrics",
            ...
            UrlMap(
                ...
                controller="gwdm.controllers_ajax.get_raster_attributes",
            ),
        )
